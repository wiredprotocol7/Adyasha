...
create_file_final(baseurl=baseurl, typescript='cucumber', projectid='pet', userstoryid='store',
                ...
                endpoint=endpoint, method='GET', parameter_values='petid',
                headers={'Content-type': 'application/json'})
create_file_final(baseurl=baseurl,typescript='cucumber',projectid='pet',userstoryid='storeorder',featurename = 'Finding the order using order id using GET API', scenarioname ='Get order by order id' ,endpoint ='store/order/2' , method='GET',parameter_values='orderid',headers = {'Content-type': 'application/json'})
...
# create_file(baseurl=baseurl3,typescript='addtostepsscript',projectid='peet',userstoryid='storee',featurename = 'testing github API authentication', scenarioname ='API authentication for github' ,endpoint =endpoint3 , pointingattribute = 'githubuserid2', method='GET',parameter={'type':'all'},parameter_values='githubuserid2', headers=githubheader)
create_file_final(baseurl=baseurl2,contenttype='xml',typescript='cucumber',projectid='http',userstoryid='authcheck',featurename = 'testing httpbin API authentication', scenarioname ='API authentication for httpbin' ,endpoint =endpoint2 , method='GET',parameter=None,parameter_values='userid',auth="('user', 'pass')",auth_type='HTTPDigestAuth')
